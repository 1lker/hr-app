...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Thank you for applying for the position of <strong>${position}</strong> at Bosch. We have successfully received your application and are excited to review it.</p>
      ...
      <p>Our hiring team will carefully review your application and get back to you as soon as possible regarding the next steps in the process. Please note that due to the high volume of applications we receive, this may take some time.</p>
      
      <p>In the meantime, you can check the status of your application through our candidate portal:</p>
      
      <a href="#" class="cta-button">Check Application Status</a>
      
      <p>If you have any questions or need to update your application, please don't hesitate to contact our HR department at <a href="mailto:${hrEmail}">${hrEmail}</a>.</p>
